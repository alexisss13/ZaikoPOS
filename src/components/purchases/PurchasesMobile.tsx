    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-200 bg-white">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <Button
                variant="ghost"
                className="h-9 w-9 p-0 text-slate-600 hover:bg-slate-100 rounded-xl"
              ...
              {showMenu && (
                <>
                  ...
                  <div className="absolute right-0 top-12 w-40 bg-white border border-slate-200 shadow-xl rounded-xl p-1.5 z-50">
                    {selectedPurchase.supplier?.phone && (
                      <button
                        onClick={() => {
                          shareViaWhatsApp(selectedPurchase);
                          setShowMenu(false);
                        }}
                        className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-bold text-green-600 hover:bg-green-50"
                      >
                    ...
                    <button
                      onClick={() => {
                        exportSinglePurchaseToPDF(selectedPurchase);
                        setShowMenu(false);
                      }}
                      className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-bold text-red-600 hover:bg-red-50"
                    >
            ...
            {/* Botón Editar (solo para órdenes pendientes) */}
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-3 bg-slate-50">
          ...
          {selectedPurchase.status === 'PENDING' && canManage && (
            <div className="space-y-3">
              {/* Botón principal - Marcar como recibida */}
              <Button
              ...
              {/* Botón secundario - Cancelar orden */}
              <Button
                onClick={handleCancelPurchase}
                variant="outline"
                className="w-full h-11 border-2 border-red-200 text-red-600 hover:bg-red-50 font-bold rounded-xl text-sm"
              >
