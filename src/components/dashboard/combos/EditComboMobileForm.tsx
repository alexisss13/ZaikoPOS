...
interface EditComboMobileFormProps {
  combo: any;
  onClose: () => void;
  onSuccess: () => void;
  categories: any[];
...
export function EditComboMobileForm({ combo, onClose, onSuccess, categories, branches }: EditComboMobileFormProps) {
    ...
    <div className="fixed inset-0 bg-white z-50 flex flex-col">
      ...
      <div className="flex items-center gap-3 px-4 py-3 border-b border-slate-200 bg-white">
        ...
        <div className="flex-1">
          <h2 className="text-lg font-black text-slate-900">Editar Combo</h2>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600">Modifica los productos que incluirá este combo</p>
              </div>
              {comboItems.length > 0 && (
        ...
        {step === 3 && (
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm text-slate-600">Modifica las imágenes del combo</p>
            </div>
